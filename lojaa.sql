...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06/05/2025 às 23:07
...
CREATE TABLE `gestaoquartos` (
  ...
  `estoque_toalhas` int(11) DEFAULT NULL,
  `estoque_lencois` int(11) DEFAULT NULL,
  `status_limpeza` varchar(50) DEFAULT NULL,
  `status_manutencao` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
