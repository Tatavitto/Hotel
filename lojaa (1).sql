...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02/06/2025 às 22:56
...
INSERT INTO `funcionarios` (`id`, `nome`, `cargo`, `turno`, `tarefa`, `tarefas`, `telefone`) VALUES
(11, 'joao vitor', 'Gerente', 'Dia', NULL, '', '(18) 17471-1717');
...
--
-- Despejando dados para a tabela `gestaoquartos`
--

INSERT INTO `gestaoquartos` (`id`, `numero`, `estoqueToalha`, `estoqueLencol`, `status`) VALUES
(13, 15, 2, 10, 'Limpo'),
(14, 20, 10, 10, 'Em andamento');
